...
public class Casa extends Propiedad {
    ...
    public Casa(int ID, String direccion, String plano, String moneda, String formaPago, String estado, String[] fotos, String notas, Persona duenio, int m2Cubiertos, int m2Descubiertos, String ambientes, String estadoProp, String servicios_comodidades, double precio_Venta_Alquiler) {
