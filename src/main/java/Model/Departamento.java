...
public class Departamento extends Propiedad {
    ...
    public Departamento(int ID, String direccion, String plano, String moneda, String formaPago, String estado, String[] fotos, String notas, String duenio, int m2Cubiertos, int m2Descubiertos, String ambientes, String estadoProp, String servicios_comodidades, double precio_Venta_Alquiler) {
