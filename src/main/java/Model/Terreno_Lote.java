...
public class Terreno_Lote extends Propiedad {
    ...
    public Terreno_Lote(int ID, String direccion, String plano, String moneda, String formaPago, String estado, String[] fotos, String notas, Persona duenio, int m2s, String estadoProp, String servicios_comodidades, double precio_Venta_Alquiler) {
